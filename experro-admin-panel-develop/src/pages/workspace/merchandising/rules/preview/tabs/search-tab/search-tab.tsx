...
const SearchTab: React.FC<ISearchTab> = ({
  listPreviewProduct,
  t,
  onEnableDisableSiteRule,
  ...
  return (
    <>
      {listPreviewProductIsSuccess && !listPreviewProductIsLoading && (
        <>
          {listPreviewProduct &&
          listPreviewProduct.searchRule &&
          listPreviewProduct.searchRule.length > 0 ? (
            <div className="sidebar-top-section collapse-sidebar-section">
              <Collapse
                ...
                {listPreviewProduct.searchRule.map((rule, index) => {
                  return (
                    <Collapse.Panel
                      key={index}
            ...
            <div className="text-dark-gray">
              {t(
                'common.messages.no_rules_are_affecting_results_from_search_rules'
              )}
            </div>
          )}
        </>
