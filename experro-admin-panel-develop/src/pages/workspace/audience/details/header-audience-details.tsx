...
import { IAPIError, IDetailAudienceuser } from '../../../../types';
...
interface IHeaderAudienceDetails {
  ...
  detailsAudience: UseQueryResult<IDetailAudienceuser | undefined, IAPIError>;
          ...
          <span className="ant-page-header-heading-title">
            {detailsAudience.isSuccess &&
              `${t('common.labels.customer')} - #${
                detailsAudience.data?.name
                  ? detailsAudience.data?.name
                  : detailsAudience.data?.device_id
              }`}
          </span>
        </div>
      </div>
