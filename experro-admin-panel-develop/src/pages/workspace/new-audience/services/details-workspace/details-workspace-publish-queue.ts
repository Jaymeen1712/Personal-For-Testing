...
const detailsWorkspacePublishQueue = async (workspaceId: string) => {
...
const useDetailsWorkspacePublishQueue = (workspaceId: string) =>
  useQuery([API_QUERY_KEY.WORKSPACE_DETAILS, workspaceId], () =>
    detailsWorkspacePublishQueue(workspaceId)
  );

export default useDetailsWorkspacePublishQueue;
