...
const TopSelling: React.FC<ITopSelling> = ({
  ...
  return (
    <div className="position-relative">
      <h3 className='gray-text title-default m-b-4'>{t('common.labels.top_selling')}</h3>
      <p className='m-0 m-b-16 gray-text'><small>{t('common.labels.most_units_sold_in_this_period')} </small>
      </p>
                    ...
                    <Card
                      ...
                      <div className="media-content-details">
                        <div className='ant-row ant-row-space-between'>
                          ...
                          <p className='text-right font-semibold'>{product.soldQty ? product.soldQty : 0}</p>
                        </div>
                      </div>
                    </Card>
                  </Col>
