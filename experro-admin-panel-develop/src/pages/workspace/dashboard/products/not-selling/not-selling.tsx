...
const NotSelling: React.FC<INotSelling> = ({
  ...
  return (
    <div className="position-relative">
      <h3 className='gray-text title-default m-b-4'>{t('common.labels.not_selling')}</h3>
      <p className='m-0 m-b-16 gray-text'><small>{t('common.labels.viewed_but_not_sell')}</small></p>
                    ...
                    <Card
                      ...
                      <div className="media-content-details">
                        <div className='ant-row ant-row-space-between'>
                          ...
                          <p className='text-right font-semibold'>{product.purchasedCount}</p>
                        </div>
                        <div className='ant-row ant-row-space-between'>
                          <span title={product.viewedCount}>
                            {t('common.labels.sessions')}
                          </span>
                          <p className='text-right font-semibold'>{product.viewedCount}</p>
                        </div>
                      </div>
