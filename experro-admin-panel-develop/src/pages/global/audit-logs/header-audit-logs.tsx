...
const HeaderAuditLogs: React.FC<IHeaderAuditLogs> = ({
  t,
  startDate,
  endDate,
  onStartDateEndDateChange,
      ...
      <div className="headerleft ant-row ant-row-top ant-row-no-wrap">
        ...
        <div className="w-100 ant-row ant-space-vertical">
          <span className="ant-page-header-heading-title">
            {t('common.labels.audit_logs')}
          </span>
          <span className="ant-page-header-heading-sub-title m-t-4">
            {t('common.labels.audit_logs_sub_title')}
          </span>
        </div>
      </div>
...
export default HeaderAuditLogs;
