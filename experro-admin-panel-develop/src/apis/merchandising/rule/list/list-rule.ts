...
const listRule = async (
  ...
  const response = await apiClient.get<
    string,
    IAxiosResponse<{ items: IListRules[] | undefined }>
  >(
    `${APIS_ROUTES.MERCHANDISING_SERVICE}/${workspaceId}/contents/content-model-data/rules`,
    {
      params: {
        ...
        metaDataFieldsToQuery: `start_date_edti,end_date_edti,enabled_ebi,rule_title_eti,rule_type_esi,status_esi,version_id,content_model_id,environment_id,modified_at,${
